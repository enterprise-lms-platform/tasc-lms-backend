# Generated by Django 5.1.5 on 2026-02-20 19:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zoom_meeting_id",
                    models.CharField(
                        blank=True, help_text="Zoom Meeting ID", max_length=255
                    ),
                ),
                (
                    "zoom_meeting_uuid",
                    models.CharField(
                        blank=True, help_text="Zoom Meeting UUID", max_length=255
                    ),
                ),
                (
                    "zoom_host_id",
                    models.CharField(
                        blank=True, help_text="Zoom Host ID", max_length=255
                    ),
                ),
                ("zoom_topic", models.CharField(blank=True, max_length=255)),
                (
                    "join_url",
                    models.URLField(blank=True, help_text="URL for learners to join"),
                ),
                (
                    "start_url",
                    models.URLField(
                ...
                (
                    "instructor_join_url",
                    models.URLField(
                        blank=True, help_text="Alternative join URL for instructor"
                    ),
                ),
                (
                    "password",
                    models.CharField(
                        blank=True, help_text="Meeting password", max_length=50
                    ),
                ),
                ...
                (
                    "auto_recording",
                    models.BooleanField(
                        default=True, help_text="Automatically record the session"
                    ),
                ),
                (
                    "recording_url",
                    models.URLField(blank=True, help_text="URL of recorded session"),
                ),
                ...
                (
                    "recording_file_size",
                    models.PositiveIntegerField(
                        default=0, help_text="Recording file size in bytes"
                    ),
                ),
                (
                    "recording_download_url",
                    models.URLField(blank=True, help_text="Download URL for recording"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "waiting_room",
                    models.BooleanField(default=True, help_text="Enable waiting room"),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="catalogue.livestreamsession",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["course", "status"], name="catalogue_l_course__4f30b9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="livestreamsession",
        ...
        migrations.AddIndex(
            model_name="livestreamsession",
            index=models.Index(
                fields=["start_time", "status"], name="catalogue_l_start_t_d8583b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="livestreamsession",
            index=models.Index(
                fields=["zoom_meeting_id"], name="catalogue_l_zoom_me_8c54b8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="livestreamattendance",
            index=models.Index(
                fields=["session", "status"], name="catalogue_l_session_1f16e6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="livestreamattendance",
            index=models.Index(
                fields=["learner", "joined_at"], name="catalogue_l_learner_14e3f5_idx"
            ),
        ),
